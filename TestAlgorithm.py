...
class TestCases:
	...
	def open_test_data(
		...
		interval=None, loc_alg=2, floor_alg=2, bin_strategy=3, top_n=3
		):
	...
	def open_test_cases(
		...
		loc_alg=2, floor_alg=2, bin_strategy=3, top_n=3
	):
	...
	def open_results(self, results, loc_alg=2, floor_alg=2, bin_strategy=3, top_n=3):
